class Character():
    ...
    def setBasic(self, new_basic):
        self.__basic = new_basic
...
# Accessing and printing character attributes using getters
print(character1.getUsername())
print(character1.getHp())
print(character1.getDamage())
print(character1.getStr())
print(character1.getVit())
print(character1.getInt())
print(character1.getAgi())
